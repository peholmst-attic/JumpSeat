...
${OBJECTDIR}/alert_logger.o: alert_logger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/alert_logger.o alert_logger.cpp
...
${OBJECTDIR}/modem_io.o: modem_io.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modem_io.o modem_io.cpp

${OBJECTDIR}/response_dispatcher.o: response_dispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/response_dispatcher.o response_dispatcher.cpp

${OBJECTDIR}/sms_logger.o: sms_logger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sms_logger.o sms_logger.cpp
